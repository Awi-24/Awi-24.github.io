...
const HACKING_MESSAGES = [
  "INITIALIZING ICE-BREAKER PROTOCOL...",
  "BYPASSING BLACKWALL_FIREWALL...",
  "INJECTING SHARD: WIDMER_OS.exe...",
  "ACTIVATING SANDEVISTAN_OVERCLOCK...",
  "CONNECTING GITHUB://AWI-24...",
  "AUTHENTICATING: CORPO_CERTIFIED...",
  "SYSTEM ADRIAN.WIDMER ONLINE...",
  "FULL ACCESS GRANTED...",
]
